...
注意：このモバイルアプリは完成までには至らず、現在は開発を中止していますが、製作物の一端として保存しています。
理由→ 1.レシートごとの印字されている位置・商品表示による違いによりOCRの精度を高めることが困難だった。
 　　 2.チラシなどから最新情報をキャッチアップするが、権利関係の問題や、大手企業との連携問題を解消できなかった。
